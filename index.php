    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
              ...
              <form id="Login" role="form">
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input name="use_email" class="form-control" placeholder="Email" type="email">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input name="use_password" class="form-control" placeholder="Senha" type="password">
                  </div>
                </div>
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a href="<?= BASE; ?>/recover.php" class="text-light"><small>Esqueceu a Senha?</small></a>
            </div>
